 ...
 * API 2: 建立預約 / 今日報到
 */
app.post("/api/kiosk/create-appointment", validateCreateAppointment, async (req: Request, res: Response) => {
  ...
  // 💡 假設這裡的 SQL 語法故意寫錯（例如寫成 INSERT INTO 不存在的資料表），Express 5 會默默捕捉並交給 errorHandler
  await db.run(
